...
- **多源事件订阅**：支持 RSS、GitHub、Webhook 等多种安全情报来源，自动定时抓取
...
| `subscriptions` | id, name, url, type(rss/github/webhook), cron_expr, enabled, last_fetch_at | 订阅源配置 |
